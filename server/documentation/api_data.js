define({ "api": [
  {
    ...
    "sampleRequest": [
      {
        "url": "https://rafaelgssa.com/esgst/game/{type}/{id}[?filters=...]"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://rafaelgssa.com/esgst/games[?join_all=...&format_array=...&show_id=...&app_ids=...&sub_ids=...&bundle_ids=...&app_filters=...&sub_filters=...&bundle_filters=...]"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://rafaelgssa.com/esgst/games/rcv[?format_array=...&show_id=...&show_name=...&app_ids=...&sub_ids=...&date_after=...&date_after_or_equal=...&date_before=...&date_before_or_equal=...&date_equal=...]"
      }
    ]
  },
  {
