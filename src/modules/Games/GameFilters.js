				...
				gmf_m: {
					description: [
						[
							...
							[
								...
								[
									'li',
									'To prevent confusion, in discussion pages the filter bar for this feature will be at the top, while the filter bar for Comment Filters (if enabled) will be at the main page heading.',
								],
								[
									'li',
								...
								[
									...
									[
										[
											'li',
											`Basic filters are related to a numeric value and have a slider that you can use to set the range of the filter (any games that do not apply to the range will be hidden).`,
										],
										[
											'li',
											`Type filters are related to a boolean value  and have a checkbox that changes states when you click on it. The checkbox has 3 states:`,
										],
										[
											'ul',
											[
					...
					features: {
						...
						gf_rating: {
							...
							description: [['ul', [['li', 'Allows you to filter games by rating percentage.']]]],
							name: 'Rating',
							sg: true,
						},
						gf_reviews: {
							dependencies: ['gc', 'gc_r'],
							description: [
								['ul', [['li', 'Allows you to filter games by the number of reviews.']]],
							],
							name: 'Reviews',
							sg: true,
						},
						gf_releaseDate: {
							...
							description: [['ul', [['li', 'Allows you to filter games by release date.']]]],
							name: 'Release Date',
							sg: true,
						},
						gf_owned: {
							description: [['ul', [['li', 'Allows you to filter games that you own on Steam.']]]],
							name: 'Owned',
							sg: true,
						},
						gf_wishlisted: {
							description: [
								['ul', [['li', 'Allows you to filter games that you have wishlisted on Steam.']]],
							],
							name: 'Wishlisted',
							sg: true,
						},
						gf_followed: {
							description: [
								['ul', [['li', 'Allows you to filter games that you have followed on Steam.']]],
							],
							name: 'Followed',
							sg: true,
						...
						gf_hidden: {
							description: [
								['ul', [['li', 'Allows you to filter games that you have hidden on SteamGifts.']]],
							],
							name: 'Hidden',
							sg: true,
						},
						gf_ignored: {
							description: [
								['ul', [['li', 'Allows you to filter games that you have ignored on Steam.']]],
							],
							name: 'Ignored',
							sg: true,
						},
						...
						gf_previouslyWon: {
							description: [
								['ul', [['li', 'Allows you to filter games that you have previously won.']]],
							],
							name: 'Previously Won',
							sg: true,
						},
						gf_fullCV: {
							description: [['ul', [['li', 'Allows you to filter games that give full CV.']]]],
							name: 'Full CV',
							sg: true,
						},
						gf_reducedCV: {
							description: [['ul', [['li', 'Allows you to filter games that give reduced CV.']]]],
							name: 'Reduced CV',
							sg: true,
						},
						gf_noCV: {
							description: [['ul', [['li', 'Allows you to filter games that give no CV.']]]],
							name: 'No CV',
							sg: true,
						},
						gf_learning: {
							...
							description: [
								['ul', [['li', 'Allows you to filter games that Steam is learning about.']]],
							],
							name: 'Learning',
							sg: true,
						},
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to filter games that have been removed from the Steam store.',
										],
									],
								],
							],
						...
						gf_banned: {
							...
							description: [
								['ul', [['li', 'Allows you to filter games that are banned on Steam.']]],
							],
							name: 'Banned',
							sg: true,
						},
						gf_tradingCards: {
							...
							description: [
								['ul', [['li', 'Allows you to filter games that have trading cards.']]],
							],
							name: 'Trading Cards',
							sg: true,
						},
						gf_achievements: {
							...
							description: [['ul', [['li', 'Allows you to filter games that have achievements.']]]],
							name: 'Achievements',
							sg: true,
						},
						gf_singleplayer: {
							dependencies: ['gc', 'gc_sp'],
							description: [['ul', [['li', 'Allows you to filter games that are singleplayer.']]]],
							name: 'Singleplayer',
							sg: true,
						},
						gf_multiplayer: {
							dependencies: ['gc', 'gc_mp'],
							description: [['ul', [['li', 'Allows you to filter games that are multiplayer.']]]],
							name: 'Multiplayer',
							sg: true,
						},
						gf_steamCloud: {
							dependencies: ['gc', 'gc_sc'],
							description: [['ul', [['li', 'Allows you to filter games that have Steam Cloud.']]]],
							name: 'Steam Cloud',
							sg: true,
						},
						gf_linux: {
							...
							description: [
								['ul', [['li', 'Allows you to filter games that have are compatible with Linux.']]],
							],
							name: 'Linux',
							sg: true,
						},
						gf_mac: {
							...
							description: [
								['ul', [['li', 'Allows you to filter games that are compatible with Mac.']]],
							],
							name: 'Mac',
							sg: true,
						},
						gf_dlc: {
							...
							description: [['ul', [['li', 'Allows you to filter games that are DLCs.']]]],
							name: 'DLC',
							sg: true,
						},
						gf_dlcOwned: {
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to filter games that are DLCs and have a non-free base game.',
										],
									],
								],
							],
						...
						gf_package: {
							...
							description: [['ul', [['li', 'Allows you to filter games that are packages.']]]],
							name: 'Package',
							sg: true,
						},
						gf_earlyAccess: {
							...
							description: [
								['ul', [['li', 'Allows you to filter games that are in early access.']]],
							],
							name: 'Early Access',
							sg: true,
						},
						gf_genres: {
							...
							description: [['ul', [['li', 'Allows you to filter games by genre.']]]],
							name: 'Genres',
							sg: true,
						},
						gf_tags: {
							dependencies: ['gt'],
							description: [['ul', [['li', 'Allows you to filter games by game tags.']]]],
							name: 'Game Tags',
							sg: true,
						},
					},
