...
class GiveawaysNextPreviousTrainHotkeys extends Module {
	constructor() {
		...
		this.info = {
			description: () => (
				<ul>
					<li>Allows you to navigate through a train using hotkeys.</li>
					<li>
						This feature is not 100% accurate, because the feature looks for a link with any
						variation of "previous"/"next" in the giveaway's description to make sure that it is
						going backward/forward, so if it does not find such a link, it will not work.
					</li>
