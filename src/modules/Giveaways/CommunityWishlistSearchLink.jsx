			...
			description: () => (
				<ul>
					<li>
						...
						<a href="https://www.steamgifts.com/giveaways/wishlist">community wishlist</a> page into
						links that allow you to search for all of the active giveaways for the game (that are
						visible to you).
					</li>
				</ul>
			),
			...
			createElements(giveawayCount, 'atinner', [
				{
					...
					type: 'a',
					children: [
						...Array.from(giveawayCount.childNodes).map((x) => {
							return {
								context: x,
							};
						}),
