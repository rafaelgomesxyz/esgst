			...
			features: {
				...
				gf_m: {
					description: [
						[
							...
							[
								[
									'li',
									'Allows you to hide multiple giveaways in a page using many different filters.',
								],
								[
									'li',
									[
								...
								[
									'li',
									`Adds a collapsible panel below the same main page heading that allows you to change/save the rules of a preset. The filters are separated in 3 categories:`,
								],
								[
									'ul',
									[
										[
											'li',
											`Basic filters are related to a numeric value (such as the level of a giveaway) and have a slider that you can use to set the range of the filter (any giveaways that do not apply to the range will be hidden).`,
										],
										[
											'li',
											`Type filters are related to a boolean value (such as whether or not a giveaway was created by yourself) and have a checkbox that changes states when you click on it. The checkbox has 3 states:`,
										],
										[
											'ul',
											[
										...
										[
											'li',
											`Category filters are essentially the same thing as type filters, but for game categories ([id=gc]).`,
										],
									],
								],
								[
					...
					features: {
						...
						gf_level: {
							description: [['ul', [['li', 'Allows you to filter giveaways by level.']]]],
							name: 'Level',
							sg: true,
						},
						gf_entries: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways by number of entries.']]],
							],
							name: 'Entries',
							sg: true,
						},
						gf_copies: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways by number of copies.']]],
							],
							name: 'Copies',
							sg: true,
						},
						gf_points: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways by how many points they cost.']]],
							],
							name: 'Points',
							sg: true,
						},
						gf_comments: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways by number of comments.']]],
							],
							name: 'Comments',
							sg: true,
						},
						gf_minutesToEnd: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways by how much time they have left.']]],
							],
							name: 'Minutes To End',
							sg: true,
						},
						gf_minutesFromStart: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways by how long ago they started.']]],
							],
						...
						gf_chance: {
							dependencies: ['gwc'],
							description: [['ul', [['li', `Allows you to filter giveaways by chance (basic).`]]]],
							name: 'Chance',
							sg: true,
						},
						gf_projectedChance: {
							...
							description: [
								['ul', [['li', `Allows you to filter giveaways by projected chance (advanced).`]]],
							],
						...
						gf_ratio: {
							dependencies: ['gwr'],
							description: [['ul', [['li', `Allows you to filter giveaways by ratio (basic).`]]]],
							name: 'Ratio',
							sg: true,
						},
						gf_projectedRatio: {
							...
							description: [
								['ul', [['li', `Allows you to filter giveaways by projected ratio (advanced).`]]],
							],
						...
						gf_pointsToWin: {
							dependencies: ['gptw'],
							description: [['ul', [['li', 'Allows you to filter giveaways by points to win.']]]],
							name: 'Points To Win',
							sg: true,
						},
						gf_rating: {
						...
						gf_releaseDate: {
							...
							description: [
								['ul', [['li', 'Allows you to filter giveaways by release date of the game.']]],
							],
							name: 'Release Date',
							sg: true,
						},
						gf_pinned: {
							description: [['ul', [['li', 'Allows you to filter giveaways that are pinned.']]]],
							name: 'Pinned',
							sg: true,
						},
						gf_public: {
							description: [['ul', [['li', 'Allows you to filter giveaways that are public.']]]],
							name: 'Public',
							sg: true,
						},
						gf_inviteOnly: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways that are invite only.']]],
							],
							name: 'Invite Only',
							sg: true,
						},
						gf_group: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways that are for groups.']]],
							],
							name: 'Group',
							sg: true,
						},
						gf_whitelist: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways that are for whitelist.']]],
							],
							name: 'Whitelist',
							sg: true,
						},
						gf_regionRestricted: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways that are region restricted.']]],
							],
							...
							description: [
								[
									...
									[
										...
										[
											'li',
											`The difference between this filter and [id=gf_currentlyEnterable] is that this filter checks if you are allowed to enter the giveaway, not if you can enter the giveaway at the moment (for example, if the giveaway has not started yet or you do not have enough points to enter the giveaway, the giveaway is considered as enterable, just not currently enterable).`,
										],
									],
								],
							],
							...
							description: [
								[
									...
									[
										...
										[
											'li',
											`The difference between this filter and [id=gf_enterable] is that this filter checks if you can enter the giveaway at the moment, not if you are allowed to enter the giveaway (for example, if the giveaway has not started yet or you do not have enough points to enter the giveaway, the giveaway is not considered as currently enterable, but just enterable).`,
										],
									],
								],
							],
						...
						gf_created: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways created by yourself.']]],
							],
							name: 'Created',
							sg: true,
						},
						...
						gf_awaitingFeedback: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways that are awaiting feedback.']]],
							],
						...
						gf_entered: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways that you have entered.']]],
							],
							name: 'Entered',
							sg: true,
						},
						gf_started: {
							description: [['ul', [['li', 'Allows you to filter giveaways that have started.']]]],
							name: 'Started',
							sg: true,
						},
						gf_ended: {
							description: [['ul', [['li', 'Allows you to filter giveaways that have ended.']]]],
							name: 'Ended',
							sg: true,
						},
						gf_deleted: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways that have been deleted.']]],
							],
							name: 'Deleted',
							sg: true,
						},
						gf_owned: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways for games that you own on Steam.']]],
							],
							name: 'Owned',
							sg: true,
						},
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to filter giveaways for games that you have followed on Steam.',
										],
									],
								],
							],
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to filter giveaways for games that you have ignored on Steam.',
										],
									],
								],
							],
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to filter giveaways for games that you have previously entered giveaways for.',
										],
									],
								],
							],
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to filter giveaways for games that you have previously won.',
										],
									],
								],
							],
						...
						gf_bookmarked: {
							dependencies: ['gb'],
							description: [
								['ul', [['li', 'Allows you to filter giveaways that you have bookmarked.']]],
							],
							name: 'Bookmarked',
							sg: true,
						},
						gf_fullCV: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways for games that give full CV.']]],
							],
							name: 'Full CV',
							sg: true,
						},
						gf_reducedCV: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways for games that give reduced CV.']]],
							],
							name: 'Reduced CV',
							sg: true,
						},
						gf_noCV: {
							description: [
								['ul', [['li', 'Allows you to filter giveaways for games that give no CV.']]],
							],
							name: 'No CV',
							sg: true,
						},
						gf_sgTools: {
							dependencies: ['ge'],
							description: [['ul', [['li', 'Allows you to filter SGTools giveaways.']]]],
							name: 'SGTools',
							sg: true,
						},
						gf_groups: {
							dependencies: ['cl', 'ggl'],
							description: [['ul', [['li', 'Allows you to filter giveaways by group.']]]],
							name: 'Groups',
							sg: true,
						},
						gf_creators: {
							description: [['ul', [['li', 'Allows you to filter giveaways by creator.']]]],
							name: 'Creators',
							sg: true,
						},
						gf_winners: {
							description: [['ul', [['li', 'Allows you to filter giveaways by winner.']]]],
							name: 'Winners',
							sg: true,
						},
						gf_learning: {
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to filter giveaways for games that Steam is learning about.',
										],
									],
								],
							],
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to filter giveaways for games that have been removed from the Steam store.',
										],
									],
								],
							],
						...
						gf_singleplayer: {
							...
							description: [
								['ul', [['li', 'Allows you to filter giveaways for games that are singleplayer.']]],
							],
							name: 'Singleplayer',
							sg: true,
						},
						gf_multiplayer: {
							...
							description: [
								['ul', [['li', 'Allows you to filter giveaways for games that are multiplayer.']]],
							],
							name: 'Multiplayer',
							sg: true,
						},
						gf_steamCloud: {
							...
							description: [
								['ul', [['li', 'Allows you to filter giveaways for games that have Steam Cloud.']]],
							],
							name: 'Steam Cloud',
							sg: true,
						},
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to filter giveaways for games that are compatible with Mac.',
										],
									],
								],
							],
						...
						gf_dlc: {
							...
							description: [
								['ul', [['li', 'Allows you to filter giveaways for games that are DLCs.']]],
							],
							name: 'DLC',
							sg: true,
						},
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to filter giveaways for games that are DLCs and have a base game that you own.',
										],
									],
								],
							],
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to filter giveaways for games that are DLCs and have a free base game.',
										],
									],
								],
							],
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to filter giveaways for games that are DLCs and have a non-free base game.',
										],
									],
								],
							],
						...
						gf_package: {
							...
							description: [
								['ul', [['li', 'Allows you to filter giveaways for games that are packages.']]],
							],
							name: 'Package',
							sg: true,
						},
						...
						gf_genres: {
							...
							description: [['ul', [['li', 'Allows you to filter giveaways by game genre.']]]],
							name: 'Genres',
							sg: true,
						},
						gf_tags: {
							dependencies: ['gt'],
							description: [['ul', [['li', 'Allows you to filter giveaways by game tags.']]]],
							name: 'Game Tags',
							sg: true,
						},
						gf_os: {
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to quickly enable/disable SteamGifts\' "Filter by OS" filter.',
										],
									],
								],
							],
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to quickly enable/disable SteamGifts\' "Hide games you already own" filter.',
										],
									],
								],
							],
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to quickly enable/disable SteamGifts\' "Hide DLC if you\'re missing the base game" filter.',
										],
									],
								],
							],
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to quickly enable/disable SteamGifts\' "Hide giveaways above your level" filter.',
										],
									],
								],
							],
							...
							description: [
								[
									...
									[
										[
											'li',
											'Allows you to quickly enable/disable SteamGifts\' "Hide games you manually filtered" filter.',
										],
									],
								],
							],
