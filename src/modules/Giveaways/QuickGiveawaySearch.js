			...
			description: [
				[
					...
					[
						[
							'li',
							'Adds a search box before the "Giveaways" box at the header of any page that allows you to quickly search for giveaways from any page.',
						],
...
export { giveawaysQuickGiveawaySearch };
