...
class TradesHeaderTradesButton extends Module {
	constructor() {
		...
		this.info = {
			description: [
				['ul', [
					['li', 'Brings back the Trades button to the SteamGifts header.'],
				]],
			],
			id: 'htb',
	...
	init() {
		...
		Shared.header.nodes.leftNav.insertBefore(tradesButton.nodes.outer, Shared.header.buttonContainers.discussions.nodes.outer);
	}
}
