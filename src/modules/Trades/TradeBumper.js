					...
					[
						[
							...
							[
								...
								[
									'a',
									{ href: `https://www.steamtrades.com/trades/search?user=your-steam-id` },
									'created trades',
								],
					...
					description: [
						[
							...
							[
								...
								[
									'li',
									`Requires either SteamGifts or SteamTrades to be open, depending on where you have this option enabled.`,
								],
							],
						],
					],
