		...
		this.info = {
			description: [
				[
					'ul',
					[
						['li', ['Allows you to filter groups.']],
						[
							'li',
							[
						...
						[
							...
							[
								[
									'li',
									`Basic filters are related to a numeric value (such as the number of comments of a group) and have a slider that you can use to set the range of the filter (any groups that do not apply to the range will be hidden).`,
								],
								[
									'li',
									`Type filters are related to a boolean value (such as whether or not a group was created by yourself) and have a checkbox that changes states when you click on it. The checkbox has 3 states:`,
								],
								[
									'ul',
									[
						...
						[
							'li',
							'Adds a text in parenthesis to the pagination of the page showing how many groups in the page are being filtered by the filters.',
						],
					],
				],
			],
			features: {
				...
				gpf_firstGiveaway: {
					...
					description: [
						['ul', [['li', 'Allows you to filter groups by the date of the first giveaway made.']]],
					],
					name: 'First Giveaway',
					sg: true,
				},
				gpf_lastGiveaway: {
					...
					description: [
						['ul', [['li', 'Allows you to filter groups by the date of the last giveaway made.']]],
					],
					name: 'Last Giveaway',
					sg: true,
				},
					...
					description: [
						[
							...
							[
								[
									'li',
									'Allows you to filter groups by the number of average entries per giveaway.',
								],
							],
						],
					],
					...
					description: [
						[
							...
							[
								[
									'li',
									'Allows you to filter groups by the number of members that have contributed.',
								],
							],
						],
					],
				...
				gpf_winners: {
					...
					description: [
						['ul', [['li', 'Allows you to filter groups by the number of members that have won.']]],
					],
					name: 'Winners',
					sg: true,
				},
					...
					description: [
						[
							...
							[
								[
									'li',
									'Allows you to filter groups by the number of giveaways that have been made.',
								],
							],
						],
					],
				...
				gpf_creationDate: {
					...
					description: [['ul', [['li', 'Allows you to filter groups by their creation date.']]]],
					name: 'Creation Date',
					sg: true,
				},
				gpf_officialGameGroup: {
					...
					description: [
						['ul', [['li', 'Allows you to filter groups that are official game groups.']]],
					],
				...
				gpf_open: {
					dependencies: ['gs', 'gs_type'],
					description: [['ul', [['li', 'Allows you to filter groups that are open to join.']]]],
					name: 'Open',
					sg: true,
				},
				gpf_restricted: {
					dependencies: ['gs', 'gs_type'],
					description: [
						['ul', [['li', 'Allows you to filter groups that are restricted to join.']]],
					],
					name: 'Restricted',
					sg: true,
				},
				gpf_closed: {
					dependencies: ['gs', 'gs_type'],
					description: [['ul', [['li', 'Allows you to filter groups that are closed to join.']]]],
					name: 'Closed',
					sg: true,
				},
			},
