	...
	constructor() {
		...
		this.info = {
			description: () => (
				<ul>
					<li>
						Adds a button (<i className="fa fa-chevron-up"></i>) either to the bottom right corner,
						the main page heading or the footer (you can decide where) of any page that takes you to
						the top of the page.
					</li>
				</ul>
			),
